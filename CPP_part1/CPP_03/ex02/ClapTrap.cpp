...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/27 19:51:40 by cbouvet           #+#    #+#             */
/*   Updated: 2024/04/27 21:39:49 by cbouvet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(ClapTrap const &src): name(src.getName()), hit_pts(src.getHitpts()), \
energy_pts(src.getEnergypts()), attack_dmg(src.getAttackdmg())
{
