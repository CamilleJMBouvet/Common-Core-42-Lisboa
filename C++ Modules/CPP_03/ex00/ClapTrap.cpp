...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/04/26 22:01:41 by cbouvet           #+#    #+#             */
/*   Updated: 2024/04/27 23:15:22 by cbouvet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " PINK << this->name << \
	R " has desintegrated" << std::endl;
}
...
{
	std::cout << WHITE "ClapTrap " PINK << this->name \
	<< WHITE " takes " RED << amount << WHITE " points of damage " << std::endl;
